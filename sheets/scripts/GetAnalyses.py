...
class Login:
    def __init__(self):
#        url = "https://cms.cern.ch/"
#        cmd = 'ls -alh ~/private/sso-auth-cookie'
#        url = "https://icms.cern.ch/tools/idProvider/demand/http://cms.cern.ch:80/iCMS"
         url = "https://icms.cern.ch/tools/"
#        url = "https://cms.cern.ch/iCMS/jsp/iCMS.jsp?login=true"
#        url = """https://cms.cern.ch/iCMS/analysisadmin/loginnice?url='/jsp/page.jsp?mode=news'"""
        cmd = 'auth-get-sso-cookie --outfile ~/private/sso-auth-cookie -u %s ;' % (url,)
#        print("got sso-cookie to file ~/private/sso-auth-cookie")
        jar = http.cookiejar.FileCookieJar.load('~/private/sso-auth-cookie')
        CookieJar.set_cookie(jar)
        self.contents = cmd
#        print(cmd)
        loginres=''
#        print("in SSOgetPage.\n")
...
#    data = handle.getPage('https://cms.cern.ch/iCMS/analysisadmin/cadilines?awg=any')
#
...
if not os.path.exists("sheets"):
    os.makedirs("sheets")
#
if os.path.isfile("data/analyses.html"):
