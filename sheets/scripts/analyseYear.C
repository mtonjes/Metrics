...
//    }
    ...
    int TonjesPrint(){
       ...
       if (activity() == 1 && majorityUS_LPCnew() && year()>=LeastYear() && year()<MostYear()){
...
//       	std::cout << "analyse.C plot check pub, analysis: " << code << ", my version: MajAuthUS_notLPCnew(): "<<MajAuthUS_notLPCnew()<< ", MajAuthUS(): " << MajAuthUS() << ", MajAuthUSLPCnew(): " << MajAuthUSLPCnew() <<", MajAuthNotUS(): " << MajAuthNotUS()<<  std::endl;
       ...
       if (activity() == 1 && significantUS_LPCnew() && year()>=LeastYear() && year()<MostYear()){       
       ...
       if (activity() == 1 && year()>=LeastYear() && year()<MostYear()){  
       ...
       if (activity() == 3 && majorityUS_LPCnew() && year()>=LeastYear() && year()<MostYear()){
...
//       	std::cout << "analyse.C plot check pub, analysis: " << code << ", my version: MajAuthUS_notLPCnew(): "<<MajAuthUS_notLPCnew()<< ", MajAuthUS(): " << MajAuthUS() << ", MajAuthUSLPCnew(): " << MajAuthUSLPCnew() <<", MajAuthNotUS(): " << MajAuthNotUS()<<  std::endl;
        ...
        if (activity() == 3 && significantUS_LPCnew() && year()>=LeastYear() && year()<MostYear()){
       ...
       if (activity() == 2 && majorityUS_LPCnew() && year()>=LeastYear() && year()<MostYear()){
...
//       	std::cout << "analyse.C plot check pub, analysis: " << code << ", my version: MajAuthUS_notLPCnew(): "<<MajAuthUS_notLPCnew()<< ", MajAuthUS(): " << MajAuthUS() << ", MajAuthUSLPCnew(): " << MajAuthUSLPCnew() <<", MajAuthNotUS(): " << MajAuthNotUS()<<  std::endl;
       ...
       if (activity() == 2 && significantUS_LPCnew() && year()>=LeastYear() && year()<MostYear()){
       ...
       if (majorityUS_LPCnew() && activity()!=0 && year()>=LeastYear() && year()<MostYear()){
...
//    TLegend * leg = new TLegend(0.6, 0.725, 0.88, 0.875, "","brNDC");
    ...
    const TString title = TString("Number of")+axis;
...
void startTableHTML() {
    ...
    theTableHTML << "<br>Plots below use papers from "<< LeastYear()<<"-"<< MostYear()-1<<"<br>" << std::endl;
...
//        if (entries[j].year() < 12 || entries[j].year() > 14) continue ;
        ...
        if(entries[j].year() < LeastYear() || entries[j].year()>=MostYear()) continue;
